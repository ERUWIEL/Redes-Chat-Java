...
public class Servidor {
    ...
    private void conectarClienteTCP() {
        try {
            ...
            JOptionPane.showMessageDialog(null, "ERROR AL CONECTAR AL CLIENTE", ex.getMessage(),
    ...
    private void gestorCliente(Socket skCliente) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "ERROR AL GESTIONAR CLIENTE", ex.getMessage(),
                    JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                skCliente.close();
